...
/**
 * Someone asking to see another student's photo and contact details.
 *
 ...
 *
 * Approving a request does NOT by itself release anything. The backend still
 * reads hasConsent from the chain before it answers, so if the grant
 * transaction never reached the chain this row changes nothing.
 */
@Entity
